...
function HomeBlog() {
  ...
  return (
    <>
        <div className='w-full flex flex-col items-start md:items-center bg-dark text-slate-300 pt-[50px] p-4'>
            <p className='text-xl '>Popular Blogs</p>
            <h1 className='text-4xl my-4 font-bold md:text-center'>Read Blogs to <br /> Gather More Knowledge About The World</h1>
