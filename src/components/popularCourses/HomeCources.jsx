  ...
  return (
    <div className="">
      <div className="w-full flex flex-col items-start md:items-center bg-dark text-slate-200 md:pt-[50px]  realtive ">
        ...
        <div className="w-full max-w-[1400px] rounded-md flex gap-6 items-start p-4 flex-wrap bg-grayDark overflow-hidden text-white relative">
          {courses?.length > 0 ? (
            courses?.slice(0, 4)?.map((course) => (
              <div
                key={course._id}
                className="bg-dark w-[23%] min-w-[280px] text-white h-content relative group rounded-xl overflow-hidden"
              >
                <div>
                  <img
                    ...
                    <button
                      onClick={() =>
                        navigate(
                          ...
                          {
                            state: {
                              courseData: { ...course, id: course._id },
                            },
                          }
                        )
                      }
        ...
        <Link to="/courses">
          <Button
            buttonClass={"py-2 mt-8"}
            buttonName={"Browse More Courses"}
          />
        </Link>
      </div>
    </div>
