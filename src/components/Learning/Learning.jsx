  ...
  return (
    <>
        <div className=' w-full flex  pb-52 pt-16 bg-[#1c242f] text-slate-300 overflow-hidden' onMouseMove={handleMouseMove}>
            ...
            <img speed={-1} src={redball} alt="" className='absolute top-[1860px] left-[300px] transition-all duration-200 mousemove ease-linear' />
            <img speed={1} src={blueball} alt="" className='absolute left-10 z-10 transition-all duration-200 mousemove ease-linear' />
            <img speed={1} src={ball} alt="" className='absolute right-6 top-[1560px] h-28 transition-all duration-200 mousemove ease-linear' />
            <img speed={-1} src={rock} alt="" className='absolute top-[1630px] z-0 transition-all duration-200 mousemove ease-linear' />
